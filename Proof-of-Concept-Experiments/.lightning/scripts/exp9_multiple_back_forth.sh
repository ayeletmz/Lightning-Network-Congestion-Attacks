...
# Use case: Normal (Everyone return secrets), A route from Crol to Alice, back and forth Alice<->Bob 9 times and back to Crol.

HOME='/home/ayelet'
. $HOME/.lightning/scripts/logger.sh

log_file="$HOME/.lightning/logs/exp9_multiple_back_forth_$(date +'%d-%m-%Y-%H:%M:%S').log"
